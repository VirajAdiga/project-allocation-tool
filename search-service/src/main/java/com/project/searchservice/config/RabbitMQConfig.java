...
import com.project.searchservice.listeners.SearchMessageListener;
...
public class RabbitMQConfig {
    ...
    public SearchMessageListener searchMessageListener() {
        return new SearchMessageListener();
    }
    ...
    public MessageConverter jsonMessageConverter() {
        ...
        idClassMapping.put("com.theja.projectallocationservice.dto.OpeningSearchMessage", OpeningSearchMessage.class);
        idClassMapping.put("com.project.searchservice.dto.OpeningSearchMessage", OpeningSearchMessage.class);
        idClassMapping.put("__TypeId__", OpeningSearchMessage.class);
